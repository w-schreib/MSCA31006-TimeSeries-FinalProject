...
STL_SD_W_test = stl(tstrain.sd.w,s.window="periodic")
...
#SMAPE
smape_train = smape(tstrain.sd.w,fcst_sd_w_train$residuals)
smape_test = smape(tstest.sd.w,fcst_sd_w_train$mean)
